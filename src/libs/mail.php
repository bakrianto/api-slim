...
class Mailer
{
	...
	public static function send($to, $name, $subject, $html, $text)
	{
		...
		//Recipients
		$mail->AddReplyTo(MAIL_USER_EMAIL, MAIL_NAME);			// Add a "Reply-To" address (Optional)
		$mail->SetFrom(MAIL_USER_EMAIL, MAIL_NAME);
		$mail->AddAddress($to, $name);						// Add a recipient
		$mail->addBCC(MAIL_USER_EMAIL);							// Add a "BCC" address (Optional)
